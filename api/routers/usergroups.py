...
def add_user_to_group(user_group: UserGroupIn, repo: UserGroupRepository = Depends()):
...
def leave_group(user_id: int, group_id: int, repo: UserGroupRepository = Depends()):
